...
func Login(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Println("Ini decoder ", decoder)
	...
	defer r.Body.Close()
	fmt.Println("Ini userInput ", userInput)
	fmt.Println("Ini userInput userInput.Username", userInput.Username)
	...
	fmt.Println("ini models users ", user)
	fmt.Println("ini models users name", user.Name)
	fmt.Println("ini models users Password", user.Password)
	...
	fmt.Println("Ini jwt.SigningMethodHS256 ", jwt.SigningMethodHS256)
	fmt.Println("Ini tokenAlgo ", tokenAlgo)
	// signed token
